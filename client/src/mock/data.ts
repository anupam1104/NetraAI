...
export const SAMPLE_REPORT_84: VerificationReport = {
  ...
  limitations: [
    ...
    },
    {
      ...
      detail: "Gauge reading relied on one automated station; manual verification was not available to Netra.",
    },
    {
...
export const SEED_REPORTS: VerificationReport[] = [
  SAMPLE_REPORT_84,
  {
    ...
    limitations: [
      ...
      { title: "No eyewitness verification", detail: "Netra did not independently interview residents on Sagar Island." },
  ...
  },
  {
    ...
    limitations: [
      ...
      { title: "City-wide flooding", detail: "Netra cannot rule out waterlogging near, but outside, the terminal." },
