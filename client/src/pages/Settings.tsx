    ...
    <AppShell>
      <div className="relative z-10">
        ...
        <div className="mt-8 space-y-6">
          ...
          <Section
            title="Appearance"
            description="Choose how Netra looks for you."
          >
          ...
          <Section
            title="Data controls"
            description="Export or permanently delete local Netra data on this device."
          >
            <div className="flex flex-wrap gap-3">
              <Button
                ...
                onClick={() => {
                  ...
                  a.href = url;
                  a.download = `netra-reports-${new Date().toISOString().slice(0, 10)}.json`;
                  a.click();
              ...
              <Button
                ...
                onClick={() => {
                  const confirmed = window.confirm(
                    "Delete all local Netra data on this device? This removes your reports and hides demo samples."
                  );
                  if (!confirmed) return;
                  mockStore.clearAll();
                  clearPendingInput();
          ...
          >
            ...
            <p className="mt-4 text-xs leading-relaxed text-[hsl(var(--muted))]">
              By default, Netra does not store media permanently. Uploaded
