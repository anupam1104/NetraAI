...
const EVENT_HELPER =
  "State the claim as precisely as you can. More context helps Netra compare the content against external evidence.";
  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        >
          Netra does not decide what is true. It gathers evidence — metadata,
